...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, '37d37a50c8ecd5bb6f74fc0c6687136647e51b373c3a5a534fee2ec980b93c94', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/features/reconciliation/pages/ReconciliationPage.tsx', 2, 'e20f79f8e7801340e8a29cf824982e7199450e0e1e9baaffd822a46d180152fb', 'approved-ephemeral-interaction-feedback-input-state', 'Selected reconciliation tab and retained visited tabs are route-local interaction state; server queries remain authoritative.'),
  ...
  classified('local', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 2, '0b8f1f2cc8684509ebf4fec6a517c15bc069d0c21eba4363b7b62a0bfdc34943', 'approved-ephemeral-interaction-feedback-input-state', 'Visited reconciliation warehouse tabs are retained only to preserve route-local interaction state after first activation.'),
  ...
  classified('order', 'src/features/approvals/pages/ApprovalPage.tsx', 3, 'fa55fc4ab7cbef7bd1bbfc447999fde9ad4173fea331af472628d195deca8948', 'approved-ephemeral-interaction-feedback-input-state', asyncInteractionReason),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, 'c3d84101ea8dd1e32c9ab17ff3297dcf23b36c605a1fb6dc7b3ae5369414df92', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, '2883beb4ab850d76c5147c61e1966c9bbe27c5b6c39f066991d8b5716b99099a', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 2, '35991c3d5e72132e5f623fee945bd9861e86f89213a0b0f0695445c1fe549609', 'declared-domain-query-state', domainClockReason),
  ...
  classified('local', 'src/components/reconciliation/ClosedLoopTransferPanel.tsx', 3, 'c4ff9aaad498a8a6b49221cd1feb5b1c9fb960c9bae0207e07b13f18ea90ee34', 'declared-domain-query-state', 'Feature-owned UI state controls an explicit visible workflow surface or dialog.'),
