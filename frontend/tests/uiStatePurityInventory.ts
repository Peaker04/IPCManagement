...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('cache', 'src/features/system-operation/SystemOperationProvider.tsx', 1, '4251045378477d105505de6c5e52b1d807d12f00bd9d893ff9549a2d6b68b93d', 'declared-domain-query-state', 'Authenticated singleton query owns the server-authoritative operation mode and version used by route eligibility and mutations.'),
  ...
  classified('global', 'src/features/projects/pages/ReconciliationWeeklyMenuPage.tsx', 5, '1171f6f1f4a08d358ac2e91898a483b6f11619c4d11d4903f15c07731796c188', 'declared-domain-query-state', 'Explicit persisted customer/week selection for reconciliation mode, synchronized with the route query state.'),
  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, '6baa357687cf63c781e4c8ed9fcede0feafbbe930ef9aab037a9129f8b6e72d6', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/features/system-operation/SystemOperationProvider.tsx', 1, '68cefa13b2e248657b34e5596bb509878e638fd3116c7a7915a5db46860647dc', 'approved-ephemeral-interaction-feedback-input-state', 'Route-local retry sequencing prevents stale authority errors from replacing a newer successful mode snapshot.'),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, '8fb4e930f959a6ef6ba8bea0cb3e1e539d0ac533cebceea6dc04cfbda2032d72', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('time', 'src/app/layout/MainLayout.tsx', 1, 'a11dbee0901309d084ad83d692b902955ee781158387282dfeae953ce1a7e65f', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, 'add2c20be234f72851b03f5aae10ae98c7edfc5c1cca2d59e53d51aaf4ea3272', 'declared-domain-query-state', domainClockReason),
