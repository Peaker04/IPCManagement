...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('local', 'src/features/chef/pages/ChefDashboardPage.tsx', 1, 'e94a98f5e337b2d6f2ab0d416676f6c1409c72a6158ddc27f4b2da84bac3a322', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
