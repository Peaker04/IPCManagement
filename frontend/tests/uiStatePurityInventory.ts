...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, 'cf0dda370c144df9f0511a26c12f21db80ef9602f86ec82a222f64ba47ceb111', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/features/reconciliation/pages/ReconciliationPage.tsx', 2, 'c224f03ce4fd4a6127335265ab89728b4a98e2124dbdfe768d8794e0181f9c18', 'approved-ephemeral-interaction-feedback-input-state', 'Selected reconciliation tab and retained visited tabs are route-local interaction state; server queries remain authoritative.'),
  ...
  classified('local', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 2, '17b3cca0f51ba9079bd624e67da404a5f6db4aa9e6add309f4156269642bb282', 'approved-ephemeral-interaction-feedback-input-state', 'Issue draft inputs and supplemental form state remain local; selected issue identity is URL-owned and server queries remain authoritative.'),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, '773531a613988268eff781124f16dd5cd0341fccd472807dadfc60ed96396682', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, 'af96d2a0443e8df66515649ce12441a647632e4dc752a1751a86ff9b9179e186', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 2, '2e4a0a9b1f2309bdbf03082ea5c33dce8468f6bec88e0ff378fe99b6ec0fa583', 'declared-domain-query-state', domainClockReason),
