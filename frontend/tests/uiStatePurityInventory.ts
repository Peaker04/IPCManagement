...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('local', 'src/features/chef/production/ServiceRunSection.tsx', 3, 'ea07ff8659a66a27fd8f58682e7060ef5d63d4082ff76f413b69fade7afa6282', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/projects/weekly-menu/schedule/MenuAmendmentInbox.tsx', 3, '426b5a94f5210196e4922fa80c40c9dc625da98f04020564687246d12dadc5ba', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
