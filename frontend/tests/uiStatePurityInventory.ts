...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('global', 'src/features/projects/pages/ReconciliationWeeklyMenuPage.tsx', 5, 'ed2a004433092a1e2b3268b9e8ca77fb9325c47b33392280a2e98b5584663df6', 'declared-domain-query-state', 'Explicit persisted customer/week selection for reconciliation mode, synchronized with the route query state.'),
  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, '3702451759ed3dbc1f615a220605f75960862520bfd061dcc5dbf20941d527f5', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/app/layout/MainLayout.tsx', 1, '526949a085f1b95ed7574945b51fdb802ecd252f088b008b9388823b62d813f4', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/approvals/pages/ApprovalPage.tsx', 2, 'edcd59501095fbc8d941077aaa7da4a8fe1350bfb1c388b162162cd6329e61d0', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/projects/weekly-menu/demand/MaterialDemandSection.tsx', 1, '86ca7947299b0d68ac23d125e9e92afef1dfa16b04d53305e9c74397c9d0bf1c', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/chef/production/ServiceRunSection.tsx', 3, 'c3bbbb337efb5a49e9d154fa7251ecaee4787ccf589a87b940fc1da53af7c757', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/purchasing/PurchaseDecisionPanel.tsx', 5, '57696282d549dd0386ffaf58c338516cdc4d6e34fe1940f64ca3267f7922cb3a', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/reconciliation/pages/ReconciliationPage.tsx', 2, '21488c229ae283e3a9d9d30bd8468b504db28a447cdf1dced726d1b354d2964f', 'approved-ephemeral-interaction-feedback-input-state', 'Selected reconciliation tab and retained visited tabs are route-local interaction state; server queries remain authoritative.'),
  ...
  classified('local', 'src/features/reconciliation/ReconciliationWorkspace.tsx', 1, 'b7e069c484bc060bb7b8f550404e6b911ac7df132e91612a411b8659bf9388a1', 'approved-ephemeral-interaction-feedback-input-state', 'Selected exception filter is route-local interaction state; selected batch and refreshed reconciliation lines remain server-query authoritative.'),
  ...
  classified('local', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 1, '5a040f98db513bb46d701600791116bbe0dcf9e73bbe73a2b045e7fc50f2abfc', 'approved-ephemeral-interaction-feedback-input-state', 'Visited reconciliation warehouse tabs are retained only to preserve route-local interaction state after first activation.'),
  classified('local', 'src/features/warehouse/pages/WarehousePage.tsx', 4, 'e12cb74f76b24e4dccd06afbdd94919e7675e7496b7483780edb2daa0f156af3', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/warehouse/WarehouseExceptionsWorkbench.tsx', 15, '756254f37a988367c30c973e516efb819c2a192ef620d1f78d0a4be16beb41bb', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('order', 'src/features/approvals/pages/ApprovalPage.tsx', 3, '53afef332fb4b9254e6a1023cf4217a4fe1b234fe25b50f4646468cc4c1c6c96', 'approved-ephemeral-interaction-feedback-input-state', asyncInteractionReason),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, '50a4434488c35058e53786462eea7e85d769e8d6e9b3d5237434539c03102388', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  classified('order', 'src/features/purchasing/PurchaseDecisionPanel.tsx', 1, 'a056444d1a9e8cc5a69cd8e029fb17d2f09920e3e2165e6dffc971bfcff7a124', 'approved-ephemeral-interaction-feedback-input-state', asyncInteractionReason),
  ...
  classified('time', 'src/app/layout/MainLayout.tsx', 1, '03ca82da9790efe05a1c31b7c6db665a464a52fb554d187d97a28213a3f97ac8', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, 'a906bb80dc0ec1b1d056caff47e45250821f26be60bebe048dcd0e5e822cfd2a', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 1, '6f22d6005e8dfdb2b93f3a8ba65d7107c28a42371c52106cf3cd6eb9675c0f21', 'declared-domain-query-state', domainClockReason),
