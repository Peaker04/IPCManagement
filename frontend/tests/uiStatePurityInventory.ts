...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, '91d1c68cc037306dde5b381f442f67e561997d5d8ca5fbaeed16f1f19d47b0fa', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/features/warehouse/pages/WarehousePage.tsx', 4, '7027f84cfc3d3c27e4ed45cc3c1228c87ae1c570d50c72e1d9b42e50690a4208', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, '6eda02879790333d6fad5df5cf6422d5b151bb15a07db779fca8faaa0d9c4237', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, 'bcc582a0e9fea1dfb172f9b6ed9eef08042521cece471a0db0a734e6285a9728', 'declared-domain-query-state', domainClockReason),
