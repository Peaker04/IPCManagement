...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, '60c7105f64f8499ee5fcd12bdca59c2aca29c151a5cf1f160cc4afdcb8c264c5', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/features/reconciliation/ReconciliationWorkspace.tsx', 1, '3f9f32efeec206a370ef072a8be589d173c2cedb7057c87caabdb558e6d9226c', 'approved-ephemeral-interaction-feedback-input-state', 'Selected batch, exception filter and active editor are route-local interaction state; server queries remain authoritative.'),
  ...
  classified('local', 'src/features/warehouse/WarehousePurchaseReceiptDialog.tsx', 10, '5b88af95d75fe2e6d415d16b26e2a1e050c267ced8474fb5758de07a6202d81e', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, 'f0182c3b5d2ed5f9159224886e36e73966de6f87e93bc0f0462d3e95f62f792a', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('order', 'src/features/warehouse/WarehousePurchaseReceiptDialog.tsx', 1, 'cb3757e14dbc88871f454f9ad4d46efc6683582deb7cf4966ee97db8283c4b06', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, 'ef732cfa81b805f4f4a6276ba70b0bc194daf9a07b71f2764f881c5d157aa693', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/warehouse/WarehousePurchaseReceiptDialog.tsx', 1, 'da718035970e4b568b05f61e10c91ff913e0e93d48810bbcbd1d40756d8e6b46', 'justified-non-visibility-infrastructure', infrastructureClockReason),
