...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('cache', 'src/routes/routeDataPreloaders.ts', 1, '151b2de686344e69a428c001f5d4c81f553fa4c4baccbc262018e9e2db5fcb35', 'justified-non-visibility-infrastructure', 'Route preloader reads declared coordination selection and operation mode solely to warm eligible route data.'),

  classified('global', 'src/features/projects/pages/WeeklyMenuPage.tsx', 8, 'e4e5de4ccc956a81e8c9b2a2b419bc069fe6171a4f3fb33d0a16a5d08ff8e632', 'declared-domain-query-state', 'Explicit persisted customer/week selection, synchronized with the page query state.'),
  ...
  classified('local', 'src/app/layout/MainLayout.tsx', 1, '16dcefe71c90b4d2abc036e6d5a8e3948cc7335b08530d024a847218eb27e85e', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/app/pages/AdminDataPage.tsx', 1, '91a8b589393f3c50629b1d86d8e8b01977af33bd326e3d09bb2f9553f0ea037b', 'approved-ephemeral-interaction-feedback-input-state', 'Visited tabs are retained only to preserve route-local interaction state after first activation.'),
  ...
  classified('local', 'src/features/admin/components/AdvancedDisplaySettings.tsx', 3, '05369364ea63890a74da9bb5f7209597493692ba5c4842dde613f9458ef70f63', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/admin/pages/ApprovalRulesPage.tsx', 6, 'aeb28e89b6e63428936b1eb7e84b1a32c7e3bb2da7982a745cdccbe687476bf7', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/approvals/components/MenuAmendmentInbox.tsx', 2, '7b878d18cc6795c0b84cde0b3835dac9783e2a07d9e1463d1b79f7b179bed74b', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/approvals/pages/ApprovalPage.tsx', 1, '2b9e77aa6f846c608736d804d1deb8d6ba05a3bf35516a98f6fdb2719ef18948', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/approvals/pages/ApprovalDecisionDialog.tsx', 1, '0c31bf3d7980ab37d2373217e405cb811f49e28c6eafed1188f51b4b3dfcaba6', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/chef/components/material-checklist.tsx', 1, 'b15c668ea8307534c99beefdc22ad8c5b3001095ace7df529c2dd3666110c1dd', 'approved-ephemeral-interaction-feedback-input-state', 'Per-line counting progress is local interaction state; persisted acknowledgement remains server-owned at whole-issue grain.'),
  ...
  classified('local', 'src/features/chef/pages/ChefDashboardPage.tsx', 1, 'd6ec7d10e28743ac5809064d53d15ee60379da709e1d6aacc1e92d29214a99ef', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/coordination/components/action-toolbar.tsx', 3, 'b59b04a63d09a26be746cb411abe4d4affcb613a1fb33ea4b368739510642117', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('local', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 2, 'f7480204313674516780b028fae4496177e009fb616c30bbe8e805fbe66fa821', 'approved-ephemeral-interaction-feedback-input-state', 'Issue draft inputs and supplemental form state remain local; selected issue identity is URL-owned and server queries remain authoritative.'),
  classified('local', 'src/features/warehouse/pages/WarehousePage.tsx', 4, '5779600ef27ee3fda1dbffa849fdd763bd6bb70b3f4a2b2b4d72f95a2b48e9b0', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/warehouse/WarehouseBatchPurchaseReceiptDialog.tsx', 2, 'ba2e5917b4aa01475be62d454696d8fa6171b4ee13d0e378b7f01b700aab96e0', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  classified('local', 'src/features/warehouse/WarehouseReceiptLifecyclePanel.tsx', 6, '84b2940ff19871d4f10e491e851e885e4f7acc366a6c5a5d22a2b6f45e80dde9', 'approved-ephemeral-interaction-feedback-input-state', localInteractionReason),
  ...
  classified('order', 'src/features/approvals/pages/ApprovalPage.tsx', 3, '38b2ba661e5b7896aaa440055647eaf6299eb93dca0583f630bf1e272b012cc3', 'approved-ephemeral-interaction-feedback-input-state', asyncInteractionReason),
  ...
  classified('order', 'src/features/projects/pages/WeeklyMenuPage.tsx', 2, 'ac28934f6e60653a3110898c43f74ff2730caf23c02a9c2580a2d9517ab5e3a1', 'justified-non-visibility-infrastructure', asyncInteractionReason),
  ...
  classified('time', 'src/app/layout/MainLayout.tsx', 1, '4c5772a30700b7ff5ab5b7041076179729234fb1ea1ef9a32bd45721e142479e', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/coordination/components/action-toolbar.tsx', 2, 'a331406aade15f5c4c701713de3bf4387883316fb96b2afcee1d3d0396dd8fab', 'justified-non-visibility-infrastructure', infrastructureClockReason),
  ...
  classified('time', 'src/features/projects/pages/WeeklyMenuPage.tsx', 1, '37203e7a1c316514c7d4359ce873ec8a664dae92c4096b5aed5cc4ed07235bb0', 'declared-domain-query-state', domainClockReason),
  ...
  classified('time', 'src/features/warehouse/pages/ReconciliationWarehousePage.tsx', 2, '0baf74c2a47720877b7ca1c1be8c91a0e30dbf8bee475348d255bc471f4bb1be', 'declared-domain-query-state', domainClockReason),
  ...
  classified('local', 'src/features/projects/weekly-menu/schedule/WeeklyScheduleEditorDialog.tsx', 1, 'bd95b9a3e88758cbe82749c0d970ebe0a0e583623fa9818276de65e59ac319ef', 'declared-domain-query-state', 'Feature-owned UI state controls an explicit visible workflow surface or dialog.'),
