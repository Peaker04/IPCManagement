...
export const HIDDEN_STATE_BASELINE: readonly HiddenStateClassification[] = [
  ...
  classified('local', 'src/features/reconciliation/ReconciliationWorkspace.tsx', 3, '426e60837cedc6a8b61e0526b8d95ecc17922244857617dc8f54cfa30e6a379c', 'approved-ephemeral-interaction-feedback-input-state', 'Selected batch/source, exception filter, active editors and inline mutation feedback are route-local interaction state; server queries remain authoritative.'),
