...
export const weeklyMenuLifecyclePa2bRegistry: readonly WeeklyMenuLifecyclePa2bScenario[] = [
  scenario({
    ...
    source: [
      ...
      'frontend/src/features/projects/weekly-menu/shell/WeeklyMenuCommandBar.tsx:42-46',
  ...
  scenario({
    ...
    downstreamPrimaryAction: null,
    actionKind: 'mutation',
    expectedControl: { surface: 'command-bar', role: 'button', name: 'Xuất bản tuần' },
    actors: allActors,
    ...
    source: [
      ...
      'frontend/src/features/projects/weekly-menu/shell/WeeklyMenuCommandBar.tsx:47-51',
