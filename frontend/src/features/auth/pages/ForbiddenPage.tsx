...
const ForbiddenPage = () => {
  return (
    <SectionPanel className="mx-auto max-w-2xl border-slate-200 bg-white">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start" data-ui-owner="uio-h" data-ui-floorplan="uif-h" data-ui-region="uir-h">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h2 className="mt-1 text-xl font-semibold text-slate-900">Phân hệ này chưa được cấp quyền</h2>
