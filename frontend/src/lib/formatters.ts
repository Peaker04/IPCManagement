/**
 * IPC Management — Shared format helpers (Centralized & Memoized)
 *
 * Rule F4, L5: Cache Intl.NumberFormat & Intl.DateTimeFormat instances
 * Rule C4, T3: Tabular numbers output for financial and quantitative layout stability
 */
...
export const formatDateTime = (value?: string | Date | null): string => {
  ...
  return getDateTimeFormat('vi-VN', {
    day: '2-digit',
    month: '2-digit',
    year: 'numeric',
    hour: '2-digit',
