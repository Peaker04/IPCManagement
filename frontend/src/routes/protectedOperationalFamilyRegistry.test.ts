...
export const protectedOperationalFamilies: readonly ProtectedOperationalFamily[] = ([
  {
    ...
    roleSource: source('literal-guarded', 'frontend/src/routes/AppRouter.tsx:69'),
  ...
  {
    routeKey: 'ADVANCED_SETTINGS', page: 'AdvancedDisplaySettingsPage', ownerSource: 'frontend/src/features/admin/pages/AdvancedDisplaySettingsPage.tsx',
    classification: 'query-only', families: ['AdvancedDisplaySettings'], reason: 'Display preferences and UI customization settings.',
    stateSource: unknown('frontend/src/features/admin/components/AdvancedDisplaySettings.tsx:1', 'Display customization and localStorage settings.'),
    roleSource: source('literal-guarded', 'frontend/src/routes/AppRouter.tsx:71'),
    operationSource: unknown('frontend/src/features/admin/components/AdvancedDisplaySettings.tsx:1', 'UI display toggles and reset preferences.'),
    backendEnforcementSource: unknown('frontend/src/features/admin/components/AdvancedDisplaySettings.tsx:1', 'Client-side settings surface.'),
  },
  {
    ...
    roleSource: source('literal-guarded', 'frontend/src/routes/AppRouter.tsx:66'),
  ...
  },
  {
    ...
    roleSource: source('literal-guarded', 'frontend/src/routes/AppRouter.tsx:70'),
  ...
  },
  {
    ...
    roleSource: source('literal-guarded', 'frontend/src/routes/AppRouter.tsx:65'),
  ...
  },
  {
    ...
    roleSource: unknown('frontend/src/routes/AppRouter.tsx:61', 'Protected route has no additional RoleGuard permission.'),
  ...
  },
  {
    ...
    roleSource: unknown('frontend/src/routes/AppRouter.tsx:60', 'Reached after authorization denial, without its own role gate.'),
  ...
  },
  {
    ...
    roleSource: source('literal-guarded', 'frontend/src/routes/AppRouter.tsx:67'),
