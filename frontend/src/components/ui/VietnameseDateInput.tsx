...
export type InputProps = React.ComponentProps<"input"> & { weekStartOnly?: boolean }

export function VietnameseDateInput({ className, value, defaultValue, onChange, min, max, disabled, name, required, ref, weekStartOnly = false, ...props }: InputProps) {
