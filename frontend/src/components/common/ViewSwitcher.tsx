...
const viewOwnershipBindings: Record<string, import('./OperationalFrame').UiOwnershipMarker> = {
  ...
  'Chọn loại báo cáo vận hành\0reports-audit': { ownerId: 'uio-t', floorplanId: 'uif-t', regionId: 'uir-t' },
  'Chọn loại báo cáo vận hành\0reports-data-quality': { ownerId: 'uio-u', floorplanId: 'uif-u', regionId: 'uir-u' },
  'Chọn loại báo cáo vận hành\0reports-demand': { ownerId: 'uio-v', floorplanId: 'uif-v', regionId: 'uir-v' },
  'Chọn loại báo cáo vận hành\0reports-kitchen': { ownerId: 'uio-w', floorplanId: 'uif-w', regionId: 'uir-w' },
  'Chọn loại báo cáo vận hành\0reports-movement': { ownerId: 'uio-x', floorplanId: 'uif-x', regionId: 'uir-x' },
  'Chọn loại báo cáo vận hành\0reports-price': { ownerId: 'uio-y', floorplanId: 'uif-y', regionId: 'uir-y' },
  'Chọn loại báo cáo vận hành\0reports-purchase': { ownerId: 'uio-z', floorplanId: 'uif-z', regionId: 'uir-z' },
  'Chọn loại báo cáo vận hành\0reports-stock': { ownerId: 'uio-10', floorplanId: 'uif-10', regionId: 'uir-10' },
  'Chọn loại báo cáo vận hành\0reports-usage': { ownerId: 'uio-11', floorplanId: 'uif-11', regionId: 'uir-11' },
  'Chọn góc nhìn kho\0warehouse-demand': { ownerId: 'uio-13', floorplanId: 'uif-13', regionId: 'uir-13' },
  'Chọn góc nhìn kho\0warehouse-exceptions': { ownerId: 'uio-14', floorplanId: 'uif-14', regionId: 'uir-14' },
  'Chọn góc nhìn kho\0warehouse-movement': { ownerId: 'uio-15', floorplanId: 'uif-15', regionId: 'uir-15' },
  'Chọn góc nhìn kế hoạch tuần\0cost': { ownerId: 'uio-17', floorplanId: 'uif-17', regionId: 'uir-17' },
  'Chọn góc nhìn kế hoạch tuần\0demand': { ownerId: 'uio-18', floorplanId: 'uif-18', regionId: 'uir-18' },
  'Chọn góc nhìn kế hoạch tuần\0dish-materials': { ownerId: 'uio-19', floorplanId: 'uif-19', regionId: 'uir-19' },
  'Chọn góc nhìn kế hoạch tuần\0production-plan': { ownerId: 'uio-1a', floorplanId: 'uif-1a', regionId: 'uir-1a' },
  'Chọn góc nhìn kế hoạch tuần\0purchase-summary': { ownerId: 'uio-1b', floorplanId: 'uif-1b', regionId: 'uir-1b' },
  'Chọn góc nhìn kế hoạch tuần\0schedule': { ownerId: 'uio-1c', floorplanId: 'uif-1c', regionId: 'uir-1c' },
  'Chọn loại báo cáo vận hành\0price-sub-dishGroup': { ownerId: 'uio-o', floorplanId: 'uif-o', regionId: 'uir-o' },
  'Chọn loại báo cáo vận hành\0price-sub-lines': { ownerId: 'uio-p', floorplanId: 'uif-p', regionId: 'uir-p' },
  'Chọn loại báo cáo vận hành\0price-sub-period': { ownerId: 'uio-q', floorplanId: 'uif-q', regionId: 'uir-q' },
  'Chọn loại báo cáo vận hành\0price-sub-supplier': { ownerId: 'uio-r', floorplanId: 'uif-r', regionId: 'uir-r' },
}
