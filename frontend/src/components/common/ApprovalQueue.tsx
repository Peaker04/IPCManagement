...
function ApprovalMaterials({ record }: { record: ApprovalRecord }) {
  ...
  return (
    <div
      className={cn(
        "ipc-approval-zone-materials-group",
        expanded && "is-expanded",
      )}
    >
      <ul id={materialListId} className="ipc-approval-zone-materials">
      ...
      {remainingCount > 0 && (
        <button
          type="button"
          className="ipc-approval-materials-toggle"
...
export function ApprovalQueue({
  ...
  return (
    <div
      className={cn(typography.body, "ipc-approval-queue", className)}
      role="region"
                ...
                {isPriceException && (
                  <>
                    ...
                    <div>
                      ...
                      <dd className="font-semibold text-slate-800">
                        {record.materials[0]?.name ?? "Chưa có"}
                      </dd>
                    </div>
                    <div>
                      <dt className="text-xs font-medium text-slate-500">
