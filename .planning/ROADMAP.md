...
- [x] 09-03-PLAN.md — Build the immutable-aware preview manifest and protected Development endpoint
- [x] 09-07-PLAN.md — Gate request generation and expose the week/date/FULLDAY read model

**Wave 3 — reconciliation persistence** *(blocked on Wave 2)*

- [x] 09-04-PLAN.md — Add forward-only run/action evidence and package snapshot schema
...
- [x] 09-08-PLAN.md — Persist versioned supplier decisions, price exceptions, and PO uniqueness
...
- [x] 09-10-PLAN.md — Enforce strict >15% exceptions and idempotent supplier-split orders

**Wave 7 — Warehouse receiving** *(blocked on Wave 6)*

- [x] 09-11-PLAN.md — Consolidate actual receiving behind one Warehouse-only atomic writer

**Wave 8 — frontend contracts and approval handoffs** *(blocked on Wave 7)*

- [x] 09-12-PLAN.md — Wire RTK Query, Weekly Menu approval state, and Manager evidence UI

**Wave 9 — six-stage operational UI** *(blocked on Wave 8)*

- [x] 09-13-PLAN.md — Deliver the guided Purchasing workbench and Warehouse receipt interaction
