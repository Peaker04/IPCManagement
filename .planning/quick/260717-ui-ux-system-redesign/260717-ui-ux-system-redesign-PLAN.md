...
Status: Coordination `OrderTable` and Warehouse stock table completed; Purchasing/Reports/Admin remain. Warehouse stock still uses bounded API limit plus local display pagination until a server cursor contract is added.
