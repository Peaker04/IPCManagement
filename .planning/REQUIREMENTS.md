...
- [x] **PUI-01**: UI triển khai luồng sáu giai đoạn trên route/primitives hiện có, restore tuần/ngày/stage từ URL, bảng bounded, dialog accessible và có E2E tập trung.
