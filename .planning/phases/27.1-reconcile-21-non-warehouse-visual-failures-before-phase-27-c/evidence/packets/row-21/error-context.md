...
- Name: visual-routes.spec.ts >> Phase 09 deterministic visual seam >> 390x844 >> purchasing-phase09 visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  29419 pixels (ratio 0.09 of all image pixels) are different.

  Snapshot: purchasing-phase09-390x844.png

Call log:
  - Expect "toHaveScreenshot(purchasing-phase09-390x844.png)" with timeout 10000ms
