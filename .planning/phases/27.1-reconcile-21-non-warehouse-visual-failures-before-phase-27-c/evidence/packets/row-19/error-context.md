...
- Name: visual-routes.spec.ts >> Phase 09 deterministic visual seam >> 1280x900 >> purchasing-phase09 visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  36167 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: purchasing-phase09-1280x900.png

Call log:
  - Expect "toHaveScreenshot(purchasing-phase09-1280x900.png)" with timeout 10000ms
