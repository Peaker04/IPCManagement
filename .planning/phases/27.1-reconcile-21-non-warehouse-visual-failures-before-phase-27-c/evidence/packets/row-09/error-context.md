...
- Name: visual-routes.spec.ts >> visual routes >> mobile >> login visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  11717 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: login-mobile.png

Call log:
  - Expect "toHaveScreenshot(login-mobile.png)" with timeout 10000ms
...
- generic [ref=e4]:
  - generic [ref=e5]:
    - img [ref=e7]
    - heading "IPC Management System" [level=1] [ref=e9]
    - paragraph [ref=e10]: Hệ thống quản lý bếp ăn công nghiệp
  - generic [ref=e11]:
    - generic [ref=e12]:
      - generic [ref=e14]: Tài khoản
      - textbox "Tài khoản" [ref=e15]:
  ...
  - generic [ref=e21]:
    - paragraph [ref=e22]: Chế độ kiểm thử cục bộ đang bật.
    - paragraph [ref=e23]: Hãy dùng tài khoản kiểm thử được cấp cho phiên làm việc này.
```
