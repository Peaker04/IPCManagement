...
- Name: visual-routes.spec.ts >> visual routes >> desktop >> chef-dashboard visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1365px by 940px, received 1365px by 900px. 

  Snapshot: chef-dashboard-desktop.png

Call log:
  - Expect "toHaveScreenshot(chef-dashboard-desktop.png)" with timeout 10000ms
