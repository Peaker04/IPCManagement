...
- Name: visual-routes.spec.ts >> visual routes >> desktop >> purchasing visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1365px by 1345px, received 1365px by 900px. 

  Snapshot: purchasing-desktop.png

Call log:
  - Expect "toHaveScreenshot(purchasing-desktop.png)" with timeout 10000ms
