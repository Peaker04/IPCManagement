...
- Name: visual-routes.spec.ts >> visual routes >> desktop >> reports visual baseline
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  41904 pixels (ratio 0.04 of all image pixels) are different.

  Snapshot: reports-desktop.png

Call log:
  - Expect "toHaveScreenshot(reports-desktop.png)" with timeout 10000ms
  ...
  - generic [ref=e91]:
    - banner [ref=e92]:
      - generic [ref=e93]:
        - generic [ref=e94]:
          - link "Tổng quan" [ref=e95] [cursor=pointer]:
            - /url: /
          - generic [ref=e96]: /
          - generic [ref=e97]: Báo cáo vận hành
        - heading "Báo cáo vận hành" [level=1] [ref=e98]
      - generic "Ngữ cảnh vận hành" [ref=e99]:
        ...
        - generic [ref=e104]:
          - img [ref=e105]
          - generic [ref=e108]: Ca trưa · Điều phối ca
        - generic [ref=e111]: Theo dõi vận hành
    - main [ref=e112]:
      - generic [ref=e113]:
        - generic [ref=e114]:
          - generic [ref=e115]:
            - generic [ref=e116]:
              - generic [ref=e117]:
                - generic [ref=e119]: Từ ngày
                - generic [ref=e120]:
                  - textbox "Từ ngày" [ref=e121]:
                    - /placeholder: dd/mm/yyyy
                  - button "Mở lịch chọn ngày" [ref=e122]:
                    - img
              - generic [ref=e123]:
                - generic [ref=e125]: Đến ngày
                - generic [ref=e126]:
                  - textbox "Đến ngày" [ref=e127]:
                    - /placeholder: dd/mm/yyyy
                  - button "Mở lịch chọn ngày" [ref=e128]:
                    - img
              - generic [ref=e129]:
                - generic [ref=e131]: Ca
                - combobox "Ca" [ref=e132]:
                  - generic [ref=e133]: __all-shifts__
                  - img: ▼
                - textbox [ref=e134]: __all-shifts__
            - generic [ref=e135]:
              - button "Xuất dữ liệu trang hiện tại" [ref=e136] [cursor=pointer]:
                - img [ref=e137]
                - text: Xuất dữ liệu trang hiện tại
              - button "Đặt lại bộ lọc" [ref=e140] [cursor=pointer]:
                - img [ref=e141]
                - text: Đặt lại bộ lọc
          - generic [ref=e144]:
            - generic [ref=e145]:
              - img [ref=e147]
              - term [ref=e150]: Cảnh báo giá trên trang
              - definition [ref=e151]: 0/0
            - generic [ref=e152]:
              - img [ref=e154]
              - term [ref=e163]: Thiếu nguyên liệu
              - definition [ref=e164]: —
            - generic [ref=e165]:
              - img [ref=e167]
              - term [ref=e176]: Dòng tồn kho
              - definition [ref=e177]: —
            - generic [ref=e178]:
              - img [ref=e180]
              - term [ref=e189]: Nhật ký thay đổi
              - definition [ref=e190]: —
            - generic [ref=e191]:
              - img [ref=e193]
              - term [ref=e202]: Chất lượng dữ liệu
              - definition [ref=e203]: —
        - generic [ref=e205]:
          - tablist "Chọn loại báo cáo vận hành" [ref=e206]:
            - tab "Biến động giá" [selected] [ref=e207] [cursor=pointer]
            - tab "Nhu cầu nguyên liệu" [ref=e208] [cursor=pointer]
            - tab "Kế hoạch thu mua" [ref=e209] [cursor=pointer]
            - tab "Tồn kho" [ref=e210] [cursor=pointer]
            - tab "Nhập/xuất kho" [ref=e211] [cursor=pointer]
            - tab "Xuất bếp" [ref=e212] [cursor=pointer]
            - tab "Sử dụng thực tế" [ref=e213] [cursor=pointer]
            - tab "Nhật ký thay đổi" [ref=e214] [cursor=pointer]
            - tab "Chất lượng dữ liệu" [ref=e215] [cursor=pointer]
          - tabpanel "Biến động giá" [ref=e216]:
            - generic [ref=e217]:
              - generic [ref=e218]:
                - generic [ref=e219]: Góc nhìn phân tích
                - combobox "Góc nhìn phân tích biến động giá" [ref=e220]:
                  - generic [ref=e221]: lines
                  - img: ▼
                - textbox [ref=e222]: lines
              - tabpanel [ref=e223]:
                - complementary [ref=e224]:
                  - generic [ref=e225]: Hàng đợi cảnh báo giá
                  - generic [ref=e226]:
                    - img [ref=e228]
                    - paragraph [ref=e231]: Không có nguyên liệu vượt ngưỡng trong kỳ này.
                - generic [ref=e233]:
                  - heading "Bảng biến động giá nguyên liệu" [level=3] [ref=e235]:
                    - img [ref=e236]
                    - generic [ref=e239]: Bảng biến động giá nguyên liệu
                  - generic [ref=e241]:
                    - text: Tìm theo nguyên liệu, nhà cung cấp hoặc mã phiếu nhập
                    - generic [ref=e242]:
                      - img
                      - searchbox "Tìm theo nguyên liệu, nhà cung cấp hoặc mã phiếu nhập" [ref=e243]
                  - region "Bảng biến động giá nguyên liệu" [ref=e244]:
                    - table [ref=e245]:
                      - rowgroup [ref=e246]:
                        - row "Tên nguyên liệu Nguồn nhập Số lượng Giá tham chiếu Giá nhập Biến động" [ref=e247]:
                          - columnheader "Tên nguyên liệu" [ref=e248]
                          - columnheader "Nguồn nhập" [ref=e249]
                          - columnheader "Số lượng" [ref=e250]
                          - columnheader "Giá tham chiếu" [ref=e251]
                          - columnheader "Giá nhập" [ref=e252]
                          - columnheader "Biến động" [ref=e253]
                      - rowgroup [ref=e254]:
                        - row "Chưa có dữ liệu để hiển thị" [ref=e255]:
                          - cell "Chưa có dữ liệu để hiển thị" [ref=e256]
```
