...
| 003 | Preview and diagnostics | How should normalized menu results and cell-level errors be reviewed before save? | A — Source First | validation, preview, feedback |
