...
| FE migration follow-up | Cao | Dashboard đã migrate; các boundary còn legacy state handling phải được inventory và đưa về `QueryView` hoặc có exception được ghi rõ |
