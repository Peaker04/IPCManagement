...
public class UnitTest1
{
    ...
    public void ForceRegisterMigrations()
    {
        ...
        var migrations = new List<string>
        {
            ...
            "20260706033326_AddMealQuantityPlanCompletedAndConcurrency",
            "20260706034750_AddApprovalRoutingAndRules",
            "20260706093000_AddPurchaseRequestLineToInventoryReceipts"
        };
