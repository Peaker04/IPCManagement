...
{
    [Fact]
    public void DeployableModel_IsMigration71WithoutBusinessEvidencePersistence()
    {
        ...
        migrationIds.Should().HaveCount(71);
        migrationIds[^1].Should().Be("20260824161853_EnforceSingleOperationalWarehouse");
    }
