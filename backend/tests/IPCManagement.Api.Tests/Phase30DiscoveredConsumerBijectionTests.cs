...
public sealed class Phase30DiscoveredConsumerBijectionTests
{
    ...
    private static readonly string[] OperationalKpiOwners = ["OperationalKpiReportService.GetOperationalKpisAsync", "OperationalKpiReportService.QueryIssueLines"];
    ...
    [
        ...
        Row("OperationalKpiReportService.GetOperationalKpisAsync", "DEFAULT_ONLY_READ", typeof(WorkflowGenerationTests), nameof(WorkflowGenerationTests.GetOperationalKpisAsync_Should_SurfaceProductionMonitoringAlerts), OperationalKpiOwners),
        Row("OperationalKpiReportService.QueryIssueLines", "DEFAULT_ONLY_READ", typeof(WorkflowGenerationTests), nameof(WorkflowGenerationTests.GetOperationalKpisAsync_Should_SurfaceProductionMonitoringAlerts), OperationalKpiOwners),
