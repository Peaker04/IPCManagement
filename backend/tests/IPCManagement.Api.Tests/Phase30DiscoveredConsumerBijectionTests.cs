...
public sealed class Phase30DiscoveredConsumerBijectionTests
{
    ...
    private static readonly string[] AuditOwners = ["AuditReportService.GetAuditChangesAsync", "AuditReportService.ProjectFlatIssueRows"];
    ...
    ["InventoryOperationsReportService.GetSupplyLineReconciliationAsync", "InventoryReturnService.ConfirmReceiptAsync", "InventoryReturnService.EnsureExactSourceFamily", "InventoryReturnService.EnsureOwningFamilyActive", "InventoryReturnService.GetAllocationBalancesAsync", "InventoryReturnScopeLoader.LoadScopedAsync"];
    ...
    private static readonly string[] DemandReportOwners = ["DemandReportService.GetIngredientDemandAggregatePageAsync"];
    ...
    private static readonly string[] ServiceRunOwners = ["ServiceRunService.GetPageAsync", "ServiceRunService.LoadProjectionDataAsync", "ServiceRunService.MapLifecycleStatus", "ServiceRunSourceSelection.SelectRelevantIssueLines"];
    private static readonly string[] SupplementalOwners = ["SupplementalMaterialRequestService.CreateAsync", "SupplementalMaterialRequestSourceLoader.EnsureDefaultSourceFamily", "SupplementalMaterialRequestService.FulfillAsync", "SupplementalMaterialRequestSourceLoader.LoadAsync", "SupplementalMaterialRequestSourceLoader.ResolveShiftNameAsync", "SupplementalMaterialRequestPurchasingRouter.RouteAsync"];
    ...
    [
        ...
        Row("AuditReportService.GetAuditChangesAsync", "FAMILY_LABELLED_AUDIT", typeof(Phase30BusinessReadConsumerMatrixTests), nameof(Phase30BusinessReadConsumerMatrixTests.AuditAndCsv_Should_LabelEveryCollidingSourceFamily_WithExactAvailableIdentity), AuditOwners),
        Row("AuditReportService.ProjectFlatIssueRows", "FAMILY_LABELLED_AUDIT", typeof(Phase30BusinessReadConsumerMatrixTests), nameof(Phase30BusinessReadConsumerMatrixTests.AuditAndCsv_Should_LabelEveryCollidingSourceFamily_WithExactAvailableIdentity), AuditOwners),
        ...
        Row("DemandReportService.GetIngredientDemandAggregatePageAsync", "DEFAULT_ONLY_READ", typeof(WorkflowGenerationTests), nameof(WorkflowGenerationTests.GetIngredientDemandAggregatePageAsync_Should_GroupDemandByIngredientAndDate), DemandReportOwners),
        ...
        Row("InventoryReturnService.ConfirmReceiptAsync", "FAMILY_PRESERVING_COMMAND", typeof(Phase30DiscoveredConsumerBijectionTests), nameof(ReturnAndReports_PublicOraclesExerciseCompleteOwnerSet), SupplyReturnOwners),
        ...
        Row("ReconciliationActualService.SetDispositionAsync", "RECONCILIATION_ONLY_COMMAND", typeof(ReconciliationServiceTests), nameof(ReconciliationServiceTests.Actual_correction_invalidates_audited_disposition_and_requires_fresh_disposition_before_completion), ["ReconciliationActualService.SetDispositionAsync"]),
        Row("ReconciliationBatchService.GetWarehouseDailyAsync", "RECONCILIATION_ONLY_READ", typeof(ReconciliationServiceTests), nameof(ReconciliationServiceTests.AggregateAndCompletion_Should_IgnoreDefaultAndLegacyCollisionQuantities), ["ReconciliationBatchService.GetWarehouseDailyAsync", "ReconciliationBatchService.LoadLinkedIssuedQuantitiesAsync"]),
        Row("ReconciliationBatchService.LoadLinkedIssuedQuantitiesAsync", "RECONCILIATION_ONLY_READ", typeof(ReconciliationServiceTests), nameof(ReconciliationServiceTests.AggregateAndCompletion_Should_IgnoreDefaultAndLegacyCollisionQuantities), ["ReconciliationBatchService.GetWarehouseDailyAsync", "ReconciliationBatchService.LoadLinkedIssuedQuantitiesAsync"]),
        ...
        Row("ServiceRunService.LoadProjectionDataAsync", "DEFAULT_ONLY_READ", typeof(ServiceRunLifecycleTests), nameof(ServiceRunLifecycleTests.OpenAndVarianceCommands_Should_BeIdempotent_AndRecordCompleteLifecycleEvidence), ServiceRunOwners),
        Row("ServiceRunService.MapLifecycleStatus", "DEFAULT_ONLY_PROJECTION", typeof(ServiceRunLifecycleTests), nameof(ServiceRunLifecycleTests.OpenAndVarianceCommands_Should_BeIdempotent_AndRecordCompleteLifecycleEvidence), ServiceRunOwners),
        ...
        Row("SupplementalMaterialRequestSourceLoader.LoadAsync", "DEFAULT_ONLY_READ", typeof(Phase30DiscoveredConsumerBijectionTests), nameof(Supplemental_PublicLifecycleOraclesExerciseCompleteOwnerSet), SupplementalOwners),
        ...
        Row("SupplementalMaterialRequestPurchasingRouter.RouteAsync", "DEFAULT_ONLY_COMMAND", typeof(Phase30DiscoveredConsumerBijectionTests), nameof(Supplemental_PublicLifecycleOraclesExerciseCompleteOwnerSet), SupplementalOwners),
