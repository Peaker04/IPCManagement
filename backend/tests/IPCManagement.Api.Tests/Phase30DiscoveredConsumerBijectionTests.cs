...
public sealed class Phase30DiscoveredConsumerBijectionTests
{
    ...
    ["InventoryOperationsReportService.GetSupplyLineReconciliationAsync", "InventoryReturnService.EnsureExactSourceFamily", "InventoryReturnService.EnsureOwningFamilyActive", "InventoryReturnService.GetAllocationBalancesAsync", "InventoryReturnService.LoadScopedSourceLinesAsync"];
    ...
    [
        ...
        Row("InventoryReturnService.LoadScopedSourceLinesAsync", "FAMILY_SCOPED_READ", typeof(Phase30DiscoveredConsumerBijectionTests), nameof(ReturnAndReports_PublicOraclesExerciseCompleteOwnerSet), SupplyReturnOwners),
