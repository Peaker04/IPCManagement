...
public class CoordinationTransactionTests
{
    ...
    private static async Task CreateMinimalSchemaAsync(SqliteConnection connection)
    {
        var commands = new[]
        {
            ...
            "CREATE TABLE customerweekmenutiers (tierId BLOB NOT NULL PRIMARY KEY, customerId BLOB NOT NULL, weekStartDate TEXT NOT NULL, priceTierAmount TEXT NOT NULL, createdAt TEXT NOT NULL, UNIQUE(customerId, weekStartDate));",
