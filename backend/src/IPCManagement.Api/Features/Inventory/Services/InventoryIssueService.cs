...
public class InventoryIssueService : IInventoryIssueService
{
    ...
    private readonly ReconciliationInventoryIssueCreator _reconciliationCreator;
        ...
        IInventoryIssuePreWriteGate? preWriteGate = null)
    {
        ...
        _reconciliationCreator = new ReconciliationInventoryIssueCreator(
            issueRepository,
            unitOfWork,
            stockLedgerService,
            transactionRunner,
    ...
    public async Task<InventoryIssueCreatedDto?> CreateAsync(CreateInventoryIssueRequest dto, string? userId)
    {
        ...
        if (hasReconciliationSource)
            return await _reconciliationCreator.CreateAsync(dto, userIdBytes);
